...
See the [Submission](./submission.html) page for full instructions on repository structure and how to grant the organisers access. Submissions must be hosted as a **private GitHub repository**. Participants without a GitHub account should create one — it's free.
